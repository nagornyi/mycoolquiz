// Quiz: classic English & Ukrainian poetry
export default {
  id: "poetry-quiz",
  title: "Poetry Quiz",
  languages: [
  ...
  localisations: {
    en: {
      ...
      maxscore: "You have guessed all of the poets, an incredible result! This shows that you know classic English poetry very well. Perhaps you have a degree in philology?",
      highscore: "You have guessed almost all of the poets, a great result! This shows that you know classic English poetry very well. Perhaps you have a degree in philology?",
      avgscore: "Well done! Despite the fact that you didn't guess some of the poets, we were impressed with your knowledge of classic English poetry. Perhaps you write a little poetry yourself?",
      lowscore: "Congratulations! The fact that you have completed this test shows that you are interested in classic English poetry. We wish you to read more poetry in the new year and find your favourite poet!"
    },
    uk: {
      quiz_name: "Як добре ви знаєте українських поетів 20-х і 30-х років XX століття? 📚",
      quiz_description: "Наприкінці першого — на початку другого десятиліття XX століття в українській літературі відбувається зміна літературних поколінь. Основними складниками світогляду новітньої еліти були бунт, самостійність мислення та щира віра у власні ідеали. Переважно це були інтелектуали, які робили ставку на особистість, а не на масу. Цей тест покаже наскільки добре ви знаєте українських поетів 20-х і 30-х років XX століття.",
      maxscore: "Ви вгадали всіх поетів, неймовірний результат! Це говорить про те що ви дуже добре знаєте українську поезію 20-х і 30-х років XX століття. Можливо у вас філологічна освіта?",
      highscore: "Ви вгадали майже всіх поетів, чудовий результат! Це говорить про те що ви дуже добре знаєте українську поезію 20-х і 30-х років XX століття. Можливо у вас філологічна освіта?",
      avgscore: "Гарний результат! Незважаючи на те що деяких поетів ви не вгадали, нас приємно вразили ваші знання української поезії 20-х і 30-х років XX століття. Можливо ви й самі трохи пишете вірші?",
      lowscore: "Вітаємо! Вже той факт що ви пройшли цей тест, каже про вашу цікавість до української поезії. Бажаємо вам у новому році читати більше віршів і знайти свого улюбленого поета!"
    }
  },
  // Only needed if this quiz should behave or look different from the
  // shared defaults in seed/globalUiConfig.js.
  uiconfig: {}
};
