export const questions = {
  en: [
    {
      question: `<br><br><p>I was angry with my friend;<br>
    ...
    {
      question: `<br><br>It keeps eternal whisperings around<br>
    ...
    {
      question: `<br><br><p>When icicles hang by the wall<br>
    ...
    {
      question: `<br><br>When I consider how my light is spent<br>
    ...
    {
      question: `<br><br><p>I wandered lonely as a cloud<br>
    ...
    {
      question: `<br><br>I met a traveler from an antique land<br>
  ...
  uk: [
    {
      question: `<br><br><p>Овес росте край неба у пісках,<br>
    ...
    {
      question: `<br><br><p>Гарячий день — і враз достигне жито,<br>
    ...
    {
      question: `<br><br><p>Дві паралелі, два меридіяни —<br>
    ...
    {
      question: `<br><br><p>Я палаю захватом, я чекаю вечора<br>
    ...
    {
      question: `<br><br><p>Підводяться, мов сонні, велетенські леви, силюети<br>
    ...
    {
      question: `<br><br>Далека сестро по природі,<br>
    ...
    {
      question: `<br><br><p>Хоч як звели тебе гермокопіди<br>
